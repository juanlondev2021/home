({
    CheckTabsCompletion : function(component) {
        ...
        this.CheckInstallationProduct(component);
        this.CheckgeneralInfo(component);
        this.CheckUtility(component);
    ...
    CheckInstallationProduct: function(component) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                var responseValue = response.getReturnValue();
                component.set("v.InstallationProductCompletion",responseValue);
    ...
    CheckUtility : function(component) {
        var action = component.get("c.checkUtilityInformation");
        action.setParams( {
            recordId : component.get("v.recordId")
        });
        action.setCallback(this, function(response) {
            var state = response.getState();
            console.log('Check Utility',state);
            if (state === "SUCCESS") {
                var responseValue = response.getReturnValue();
                component.set("v.utilityInfoCompletion",responseValue);
                console.log('Response check:',responseValue)
