({
    doInit: function (cmp, event, helper) {
      if ( cmp.get("v.value") != null ) {
          helper.fetchLookUpValueCmp(
            cmp,
            cmp.get("v.value"),
            cmp.get("v.objectAPIName")
          );
        }
        var action = cmp.get("c.isRequired");
        $A.enqueueAction(action);
    
        //console.log('value:', cmp.get("v.value"));
    },
  
    isRequired: function (cmp, helper, event) {
    ...
    clear: function (component, event, heplper) {
      ...
      var action = component.get("c.isRequired");
      $A.enqueueAction(action);
