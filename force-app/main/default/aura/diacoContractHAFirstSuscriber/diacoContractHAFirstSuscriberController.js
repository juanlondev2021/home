({
    ...
    handleSubmit: function(component, event, helper) {
        	...
        	console.log(fields)
            fields.Customer_1_DOB__c = component.find('Customer_1_DOB__c').get('v.value');
            component.find('recordViewForm').submit(fields);
        component.find("recordEditHS").submit();
    },
    handleLoad: function(component, event, helper) {
        component.find('Customer_1_DOB__c').set('v.value', component.find('Customer_1_DOB__c2').get('v.value'))
    }
})