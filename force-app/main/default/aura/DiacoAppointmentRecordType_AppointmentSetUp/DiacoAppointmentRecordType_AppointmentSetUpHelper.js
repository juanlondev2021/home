({
    getMatadata :  function(cmp) {
        ...
        var action = cmp.get("c.getAppointmentSetting");
        ...
        action.setCallback(this, function(response) {
            ...
            if( state === 'SUCCESS' ) {
                ...
                cmp.set('v.recordTypeHomeservice', data.homeservice_recordtypes.filter(item => item.Name.includes('Sales'))); //esto puede cambiar
            ...
            for (var i = 0; i < appointment_mtd.length; i++) {
                ...
                let homeServiceRecordType = data.homeservice_recordtypes.find(item => item.Id === appointment_mtd[i].Name );
                appointment_mtd[i].home_service_name = homeServiceRecordType == undefined ? appointment_mtd[i].Name  : homeServiceRecordType.Name;
    ...
    setColums : function(cmp) {
        ...
        var fields = [
            { label: 'Home Service', fieldName: 'home_service_name', type: 'test' },
            
            { label: 'Appointment', fieldName: 'appointment_name', type: 'text'},
